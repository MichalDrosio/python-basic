# Let us take a string composed of decimal digits: "10111213". We want to code this string as a
# string of 0 and 1 and after that be able to decode it.
#
...
def decode(strng):
    ...
    while i < len(strng):
        if strng[i] == '1':
            ...
            i += zLen + 1
            out.append(str(int(strng[i:i+zLen+1], 2)))
            i += zLen + 1
    return ''.join(out)

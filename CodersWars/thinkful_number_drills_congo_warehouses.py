...
# The function should take three arguments: the length, width,
# and height of your warehouse (in feet) and should return an integer representing
# the number of boxes you can store in that space.
#
# For example: a warehouse 32 feet long, 64 feet wide,
# and 16 feet high can hold 13,824 boxes because you can fit 24 boxes across,

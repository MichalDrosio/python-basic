...
# After the process is completed with the "n"th student, how many lockers are open?
#
# The task is to write a function which gets any number as an input and returns
# the number of open lockers after last sudent complets his activity. So input of the function is just one
# number which shows number of lockers and number of students. For example if there are 1000 lockers and
# 1000 students in school then input is 1000 and function returns number of open lockers after

...
#
# Given a string of results and the name of a team (parameter : to_find)
# your function nba_cup (or nbaCup or ...) will return as a string
#
...
#
# If a team name can't be found in the given string of results you will return "Team Name:This team didn't play!"
# (See examples below).
#
# The scores must be integers. If a score is a float number (abc.xyz...) you will return: "Error(float number):
# the concerned string"
#
# Examples:

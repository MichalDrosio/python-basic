...
# When it was growing, you added water and fertilizer, and kept a constant temperature.
# It's time check how much your plant has grown.
#
...
# temp (integer) - if the temperature given is in the range of 20°C and 30°C, the plant grows normally,
# otherwise, all the flowers die except for one flower at the end of the stem.
...
def plant(seed, water, fert, temp):
    STEM = "-"
    if 20 <= temp <= 30:
        return (STEM * water + seed * fert) * water
    else:
        return (STEM * water) * water + seed

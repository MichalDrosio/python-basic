...
# and returns a new string that is formatted across multiple lines with each new sentence
# starting on a new line when you print it out.
#
...
print(format_poem('Beautiful is better than ugly. Explicit is better than implicit. Simple is better than complex. '
                  'Complex is better than complicated.'))
...
# The Customer ID - a natural number between 0 and 17558423 inclusively,
# which is assigned to the car buyers in the following order: the first customer receives ID 0,
# the second customer receives ID 1, the third customer receives ID 2, and so on;
# Number Plate - assigned to the car and contains the series ( three Latin lowercase letters from a to z)
# and the serial number (three digits from 0 to 9).
# Example: aaa001. Each Number Plate is related to the given Customer ID. For example:
# Number Plate aaa001 is related to Customer ID 0; Number Plateaaa002 is related to Customer ID 1, and so on.
# Task:
# Write a function
#
...
# ...... ,
# zaa001...zaa999
# As soon as the left letter reached z and the seriesz** has moved through all
# the serial numbers the middle letter changes alphabetically as follows:
#
# aba001...aba999,
# bba001... bba999,
# cba001...cba999,
...
# ......,
# zza001...zza999
# As soon as the middle letter and the left letter both reached z and the serieszz* has moved
# through all it's serial numbers the right letter changes alphabetically as follows:
#
# aab001...aab999,
# bab001...bab999,
# cab001...cab999,
...
for c, j in CONFIG:
    print(f'testing: {find_the_number_plate(c)}, {j}' )
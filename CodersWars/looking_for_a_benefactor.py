...
# donations should reach an average of 30. After doing the math he found 149. He thinks that he made a mistake.
# Could you help him?
#
...
# return -1 in C, Fortran, Nim, PowerShell, Go, Prolog, Lua
# echo ERROR in Shell
...
def new_avg(arr, newavg):
    sum_arr = sum(arr)
    x = (newavg * (len(arr)+1)) - sum_arr
    if x < 0:
        return ValueError
    else:
        return round(x)

print(new_avg([14, 30, 5, 7, 9, 11, 15], 100))
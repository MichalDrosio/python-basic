...
# he must take account of an inflation of i percent per year in order to keep his quality of living.
...
# and so on...
#
# John wants to know if the banker's plan is right or wrong. Given parameters f0, p, c0, n,
# i build a function fortune which returns true if John can make a living until the nth year
...
print(fortune(100000, 2, 20000, 5, 1))

...
# and the sequence will have a maximum length of 100. The Fizz and Buzz numbers might be equal, and might be equal to 1.
#
# Examples
...
print(reverse_fiz_buzz(["Fizz", "Fizz", "Fizz", "Fizz", "Fizz", "FizzBuzz"]))
a = ["Fizz", "Fizz", "Fizz", "Fizz", "Fizz", "FizzBuzz"]
print(a)

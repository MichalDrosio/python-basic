# John wants to give a total bonus of $851 to his three employees taking fairly as possible into account their
# number of days of absence during the period under consideration.
...
# the function bonus(arr, s) will follow John's way and return an array of the fair bonuses of all employees in
# the same order as their numbers of days of absences.
#

...
# it would equal '3' + '2' + '9' converted to an integer for this kata, meaning it would equal 329.
# The output should be an array of the sum in a similar fashion to the input (for example,
...
def sum_arrays(array1, array2):
    if array1 != [] and array2 != []:
        ...
        if res[0] == '-':
            print(res[1])
            first_num = int(res[1]) - (2 * int(res[1]))

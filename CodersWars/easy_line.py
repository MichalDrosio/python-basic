...
#
# We want to calculate the sum of the squares of the binomial coefficients on a given horizontal
# line with a function called easyline (or easyLine or easy-line).
#
...
def easy_line(line):
    ...
    return result, sum(i**2 for i in result)
